...
class IRLTrainer:
    ...
    def initialize_networks(self, n_actions, checkpoints_dir=None):
        """
        Initialize actor and critic networks for IRL agent.
        """
    ...
    def optimize_model(self):
        """
        Function for agent learning that implements the IRL algorithm.
    ...
    def irl_train(self, n_episodes=1500, opt_steps=64, reward_weights=None,
